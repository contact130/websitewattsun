                    ...
                    {SERVICES.map((service: any) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-5 border-2 rounded-xl cursor-pointer transition-all duration-300 flex flex-col items-center text-center transform hover:scale-105 h-[220px] relative ${
                            isSelected
