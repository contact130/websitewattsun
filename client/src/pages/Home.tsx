      ...
      <main className="flex-grow">
        ...
        <section className="py-20 bg-gradient-to-b from-white to-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 mb-10 max-w-6xl mx-auto">
              <div className="flex items-center justify-center p-5 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="/optimized/LogoqualiPVtransparent.webp" alt="QualiPV RGE 2026 - Certification pour installations photovoltaïques" className="h-20 md:h-36 object-contain hover:scale-110 transition-transform duration-300" loading="lazy" />
              </div>
              <div className="flex items-center justify-center p-5 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="/optimized/LogoQualiPACtransparent.webp" alt="QualiPAC RGE - Certification pour pompes à chaleur" className="h-20 md:h-36 object-contain hover:scale-110 transition-transform duration-300" loading="lazy" />
              </div>
              <div className="flex items-center justify-center p-5 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="/LogoQualibatRGE.webp" alt="QUALIBAT RGE - Qualification pour isolation, menuiseries et plâtrerie" className="h-20 md:h-36 object-contain hover:scale-110 transition-transform duration-300" loading="lazy" />
              </div>
              <div className="flex items-center justify-center p-5 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="/LogoIRVE.webp" alt="IRVE - Installateur qualifié bornes de recharge" className="h-20 md:h-36 object-contain hover:scale-110 transition-transform duration-300" loading="lazy" />
              </div>
              <div className="flex items-center justify-center p-5 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="/optimized/Logorechargeelec+.webp" alt="Recharge Elec+ 2026 - Certification pour bornes de recharge" className="h-20 md:h-36 object-contain hover:scale-110 transition-transform duration-300" loading="lazy" />
              </div>
              <div className="flex items-center justify-center p-5 md:p-8 bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
                <img src="/optimized/Logoventilationtransparent.webp" alt="Ventilation+ RGE - Certification pour systèmes VMC" className="h-20 md:h-36 object-contain hover:scale-110 transition-transform duration-300" loading="lazy" />
              </div>
            </div>
